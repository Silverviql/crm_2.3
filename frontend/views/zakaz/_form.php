...
<div class="zakaz-form">
    ...
    <div class="row">
        <div class="col-lg-3 informationZakaz">
            ...
            <div class="col-lg-4" id="zakaz-number1">
        ...
        <div class="col-lg-3 clientZakaz">
            <h3>Клиент</h3>
            <div class="col-lg-12">
        ...
        <div class="col-lg-3 managmentZakaz">
            <h3>Управление</h3>
            <div class="col-lg-12">
...
$js = <<<JS
    $('#modalOrderCreate').on('beforeSubmit', 'form', function(){
	 ...
	 $.ajax({
	    url: '/zakaz/create?id=$model->id_zakaz', 
	    type: 'POST',
	    data: data,
...
$js = <<<JS
    $('#modalOrderUpdate').on('beforeSubmit', 'form', function(){
	 ...
	 var data = $(this).serialize();
	 $.ajax({
	    url: '/zakaz/update?id=$model->id_zakaz', 
	    type: 'POST',
	    data: data,
	   /* success: function(res){
	       console.log(res);
