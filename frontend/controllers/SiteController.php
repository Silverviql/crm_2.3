    ...
    public function behaviors()
    {
        return [
            'access' => [
                ...
                'only' => ['index', 'logout', 'signup','admin','analytics','manager'],
                'rules' => [
                    [
                        'actions' => ['signup'],
                        'allow' => true,
...
//            }
    ...
    {
        $array = AnalyticsList::getAll();
        return $this->render('analytics',['varInView' => $array]);
    }
